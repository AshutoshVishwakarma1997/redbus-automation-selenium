...
public final class CalendarUtils {
    ...
    public static void selectDate(String date, WebDriver driver, By nextArrow, By monthYearLabel, By datesGrid) {
        ...
        while (true) {
            WaitUtils.waitForVisibility(driver, monthYearLabel, 10);
            String displayedMonthYear = driver.findElement(monthYearLabel).getText().trim();
            ...
            WaitUtils.waitForClickability(driver, nextArrow, 10);
        ...
        WaitUtils.waitForVisibility(driver, datesGrid, 10);
        WebElement calendarGrid = driver.findElement(datesGrid);
        List<WebElement> dayCells = calendarGrid.findElements(By.xpath(".//*[normalize-space()='" + targetDay + "']"));
        if (dayCells.isEmpty()) {
